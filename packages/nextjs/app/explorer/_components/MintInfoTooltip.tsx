    ...
    <div className="relative">
      ...
      {isVisible && (
        <div className="absolute right-0 top-6 w-80 bg-slate-800 border border-slate-600 rounded-lg p-4 shadow-xl z-[100]">
          <div className="text-white font-semibold text-sm mb-2">What does &quot;Mint Cosmic NFT&quot; do?</div>
          <div className="text-slate-300 text-xs leading-relaxed space-y-2">
            <p>
              This will mint an NFT of the graph you see below, preserving its exact state and making it{" "}
              <strong>fully interactive</strong>. The NFT includes:
            </p>
